 ...
 * @since 03.03.2019
 */
public class AaloadSpec extends InstructionSpec {

    public AaloadSpec( String mnemonic, int typeId, int dataLen ) {
    ...
    public void process( int level, Instruction instruction, Stack<Operand> stack, SourceCodeWriter writer, Context context ) {
        stack.push( new Operand( OperandType.REFERENCE, "null" ) );
    }
}
