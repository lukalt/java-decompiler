 ...
 * @since 06.03.2019
 */
public class NewSpec extends InstructionSpec {

    public NewSpec( String mnemonic, int typeId, int dataLen ) {
    ...
    public void process( int level, Instruction instruction, Stack<Operand> stack, SourceCodeWriter writer, Context context ) throws DecompileException {
        ...
        stack.push( new Operand( OperandType.TYPE_REF, writer.formatClassName( className ) ) );
    }
}
