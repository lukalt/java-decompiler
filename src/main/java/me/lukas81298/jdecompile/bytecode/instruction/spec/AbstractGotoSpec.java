 ...
 * @since 07.03.2019
 */
public abstract class AbstractGotoSpec extends InstructionSpec {

    public AbstractGotoSpec( String mnemonic, int typeId, int dataLen ) {
    ...
    public abstract int getBranch( Instruction instruction );
